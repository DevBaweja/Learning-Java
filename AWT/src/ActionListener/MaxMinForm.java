...
public class MaxMinForm  extends Applet implements ActionListener{
...
print();
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
			if(a>b && a>c)
				txresult.setText("First Number: "+Integer.toString(a));
			else if(b>c)
				txresult.setText("Second Number: "+Integer.toString(b));
			else 
				txresult.setText("Third Number: "+Integer.toString(c));
		}
		else
		if(src == btmin)
		{
